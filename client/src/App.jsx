...
//         <Route
//           path="/list"
//           element={!currentUser ? <Navigate to="/" /> : <MyList />}
//         />
//         <Route
...
//           element={!currentUser ? <Navigate to="/" /> : <UpdateProduct />}
//         ></Route>
//         <Route
//           path="/cart"
//           element={!currentUser ? <Navigate to="/" /> : <Cart />}
//         ></Route>
//         <Route
//           path="/customer-orders"
//           element={!currentUser ? <Navigate to="/" /> : <CustomerOrders />}
//         ></Route>
//         <Route
//           path="/my-orders"
//           element={!currentUser ? <Navigate to="/" /> : <MyOrders />}
//         ></Route>
//         <Route
//           path="/order"
//           element={!currentUser ? <Navigate to="/" /> : <PlaceOrder />}
//         ></Route>
